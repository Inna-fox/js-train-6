...
function hasProperty(obj, property) {
  ...
  // Запишимо умову якщо властивість існує повертає текст 
  if (property in obj) {
...
//   for (let newRole of array) {
//     newRole = [userList[role]];
//   };
...
function showCarInfo({
  ...
  return console.log(brand, year, country);
}
...
function addProperty(array) {
  ...
  customProperty(array) = myProperty;
